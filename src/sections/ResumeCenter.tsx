  ...
  <section className="section" id="resume">
    <div className="container">
      ...
      <div className="resume-grid">
        <Reveal className="resume-cell resume-cell--main">
          <div className="panel resume-main">
            <div className="resume-main-group">
        ...
        <Reveal className="resume-cell resume-cell--actions" delay={100}>
        ...
        <Reveal className="resume-cell resume-cell--comp" delay={180}>
